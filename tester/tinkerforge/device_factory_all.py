...
try:
    from .bricklet_ethernet import BrickletEthernet
except (ValueError, ImportError):
    from bricklet_ethernet import BrickletEthernet
...
try:
    from .bricklet_sd_card import BrickletSDCard
except (ValueError, ImportError):
    from bricklet_sd_card import BrickletSDCard
...
try:
    from .tng_mpcie_msata import TNGMPCIEMSATA
except (ValueError, ImportError):
    from tng_mpcie_msata import TNGMPCIEMSATA

try:
    from .tng_ptc4 import TNGPTC4
except (ValueError, ImportError):
    from tng_ptc4 import TNGPTC4
...
DEVICE_CLASSES = {
    ...
    BrickletEthernet.DEVICE_IDENTIFIER: BrickletEthernet,
    ...
    BrickletSDCard.DEVICE_IDENTIFIER: BrickletSDCard,
    ...
    TNGMPCIEMSATA.DEVICE_IDENTIFIER: TNGMPCIEMSATA,
    TNGPTC4.DEVICE_IDENTIFIER: TNGPTC4,
